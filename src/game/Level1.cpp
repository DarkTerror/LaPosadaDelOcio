...
bool ChatHandler::HandleNameAnnounceCommand(char* args)
{
    ...
    switch(m_session->GetSecurity())
    {
       case SEC_MODERATOR:
         ...
         break;
       case SEC_MODERATOR_CLASS:
        strid = LANG_SYSTEMMESSAGE_MODERATOR;
        break;
       case SEC_MODERATOR_BOSS:
        strid = LANG_SYSTEMMESSAGE_MODERATOR;
        break;
       case SEC_GAMEMASTER:
         strid = LANG_SYSTEMMESSAGE_GAMEMASTER;
         break;
       case SEC_GAMEMASTER_CLASS:
        strid = LANG_SYSTEMMESSAGE_GAMEMASTER;
        break;
       case SEC_GAMEMASTER_BOSS:
        strid = LANG_SYSTEMMESSAGE_GAMEMASTER;
        break;
       case SEC_ADMINISTRATOR:
         strid = LANG_SYSTEMMESSAGE_ADMINISTRATOR;
         break;
       case SEC_ADMINISTRATOR_BOSS:
        strid = LANG_SYSTEMMESSAGE_ADMINISTRATOR;
        break;
      default:
        return false;
...
bool ChatHandler::HandleModifyEnergyCommand(char* args)
{
    ...
    int32 energy = atoi(args);
    int32 energym = atoi(args);
...
bool ChatHandler::HandleModifyRageCommand(char* args)
{
    ...
    int32 rage = atoi(args);
    int32 ragem = atoi(args);
...
bool ChatHandler::HandleModifyRunicPowerCommand(char* args)
{
    ...
    int32 rune = atoi(args);
    int32 runem = atoi(args);
